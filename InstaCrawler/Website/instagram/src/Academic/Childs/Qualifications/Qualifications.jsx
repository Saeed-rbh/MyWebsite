...
function Qualifications() {
  ...
  const startScroll = top - 60 + 500; // Where you want progress to start
  const endScroll = top - 60 + size[0] + 500; // Where you want progress to end
  ...
  const Style = {
    ...
    top: stages[2] ? `calc(5vh + ${top + 15 + 500}px)` : `calc(5vh + ${top}px)`,
    overflow: "hidden",
  };
