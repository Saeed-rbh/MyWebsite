    ...
    >
      ...
      <g>
        ...
        <g className={styles.grapheneSpirals}>
          {/* Bundle 1 (0 deg) */}
          <g transform="rotate(0, 157, 150.7)">
            <path d="M 157 110 C 107 100, 87 150, 107 190 C 137 240, 207 240, 237 190 C 277 130, 247 60, 167 40 C 77 20, 17 110, 37 190" />
            <path d="M 159 112 C 109 102, 89 152, 109 192 C 139 242, 209 242, 239 192 C 279 132, 249 62, 169 42 C 79 22, 19 112, 39 192" />
            <path d="M 155 108 C 105 98, 85 148, 105 188 C 135 238, 205 238, 235 188 C 275 128, 245 58, 165 38 C 75 18, 15 108, 35 188" />
          </g>
          {/* Bundle 2 (90 deg) */}
          <g transform="rotate(90, 157, 150.7)">
            <path d="M 157 110 C 107 100, 87 150, 107 190 C 137 240, 207 240, 237 190 C 277 130, 247 60, 167 40 C 77 20, 17 110, 37 190" />
            <path d="M 159 112 C 109 102, 89 152, 109 192 C 139 242, 209 242, 239 192 C 279 132, 249 62, 169 42 C 79 22, 19 112, 39 192" />
            <path d="M 155 108 C 105 98, 85 148, 105 188 C 135 238, 205 238, 235 188 C 275 128, 245 58, 165 38 C 75 18, 15 108, 35 188" />
          </g>
          {/* Bundle 3 (180 deg) */}
          <g transform="rotate(180, 157, 150.7)">
            <path d="M 157 110 C 107 100, 87 150, 107 190 C 137 240, 207 240, 237 190 C 277 130, 247 60, 167 40 C 77 20, 17 110, 37 190" />
            <path d="M 159 112 C 109 102, 89 152, 109 192 C 139 242, 209 242, 239 192 C 279 132, 249 62, 169 42 C 79 22, 19 112, 39 192" />
            <path d="M 155 108 C 105 98, 85 148, 105 188 C 135 238, 205 238, 235 188 C 275 128, 245 58, 165 38 C 75 18, 15 108, 35 188" />
          </g>
          {/* Bundle 4 (270 deg) */}
          <g transform="rotate(270, 157, 150.7)">
            <path d="M 157 110 C 107 100, 87 150, 107 190 C 137 240, 207 240, 237 190 C 277 130, 247 60, 167 40 C 77 20, 17 110, 37 190" />
            <path d="M 159 112 C 109 102, 89 152, 109 192 C 139 242, 209 242, 239 192 C 279 132, 249 62, 169 42 C 79 22, 19 112, 39 192" />
            <path d="M 155 108 C 105 98, 85 148, 105 188 C 135 238, 205 238, 235 188 C 275 128, 245 58, 165 38 C 75 18, 15 108, 35 188" />
          </g>
