      ...
      <style>
        {`
          .animated-quote-path {
            ...
            stroke-dasharray: 1;
            stroke-dashoffset: 1;
            animation: drawQuote 4s cubic-bezier(0.4, 0, 0.2, 1) infinite alternate;
          }
          @keyframes drawQuote {
            0%, 10% {
              stroke-dashoffset: 1;
